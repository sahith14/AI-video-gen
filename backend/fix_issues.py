...
# Create simplified video_service.py
video_service_content = '''import os
import subprocess
import asyncio
import uuid
...
# Save to services/video_service.py
with open("services/video_service.py", "w") as f:
    f.write(video_service_content)

print("✅ Created fixed video_service.py")
